...
<div class="navbar sticky top-0 z-50 bg-base-100 shadow-lg">
	...
	<div class="navbar-center hidden lg:flex">
		<ul class="menu menu-horizontal gap-2 px-1">
			...
			<li><a href="#skills" class="btn btn-outline">Skills</a></li>
			<li><a href="#projects" class="btn btn-outline">Projects</a></li>
			<li><a href="#experience" class="btn btn-outline">Experience</a></li>
	...
	<section id="contact" class="card bg-base-100 shadow-xl card-border">
		<div class="card-body">
			...
			<div class="grid grid-cols-2 gap-3 sm:flex sm:flex-wrap sm:justify-center sm:gap-4">
				<a href="mailto:your.email@example.com" class="btn btn-outline btn-sm btn-primary sm:btn-md"
					>Email</a
				>
				<a
					...
					class="btn btn-outline btn-sm btn-primary sm:btn-md">GitHub</a
				>
				<a
					href="https://linkedin.com/in/yourprofile"
					target="_blank"
					rel="noopener noreferrer"
					class="btn btn-outline btn-sm btn-primary sm:btn-md">LinkedIn</a
				>
				<a
					href="https://twitter.com/yourhandle"
					target="_blank"
					rel="noopener noreferrer"
					class="btn btn-outline btn-sm btn-primary sm:btn-md">Twitter</a
				>
			</div>
		</div>
	</section>
